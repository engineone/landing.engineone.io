  ...
  render() {
    ...
    return (
        <svg ref='child' style={{position:'relative',top:'60px'}}
            ...
            fill="none" stroke="#435977" strokeWidth="4"></path>
            :
    ...
    <g id="Icosn-upadate" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" stroke-dasharray="7" stroke-linecap="square">
        <path d={`M${(this.props.right)?8:pxwidth-8},30 L${(this.props.right)?8:pxwidth-8},${pxheight}`} id="Line-22" stroke="#435977" strokeWidth="4"></path>
    </g>
<circle id="Oval-6" cx={(this.props.right)?8:pxwidth-8} cy={pxheight-8} r="8" fill="#435977"></circle>
